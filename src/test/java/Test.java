...
//        ParameterAnalysis.analysis(arg);
        ...
        String[] arg = {"~/Research/2021/voice-coding/voice2code/src/main/java/cn/edu/lyun"
                ,"o","~/Research/2021/voice2CodeInVoiceJava"};
        ParameterAnalysis.analysis(arg);
...
//        String[] arg = {"/Users/stefanzan/Research/2021/dubbo/dubbo-cluster/src/main/java/org/apache/dubbo/rpc/cluster/configurator/parser/ConfigParser.java"};
//        ParameterAnalysis.analysis(arg);
    }
}
